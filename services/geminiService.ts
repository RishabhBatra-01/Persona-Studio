...
Remember: The person in the output must be unmistakably the SAME individual as in the input, with COMPLETE head and shoulders visible.`;
...
If the edit request conflicts with identity preservation or framing, apply the edit in a way that minimizes changes while achieving the desired effect.`;
