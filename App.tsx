...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-theme-primary selection:bg-blue-500/30 flex flex-col font-sans relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4 pointer-events-none">
        <header className="glass-panel rounded-full px-6 py-3 flex items-center justify-between gap-6 pointer-events-auto shadow-2xl shadow-black/20">
          <div className="flex items-center gap-3 cursor-pointer group" onClick={handleReset}>
            <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className={`p-2 rounded-full transition-all duration-300 ${apiKey ? 'text-emerald-500 hover:bg-emerald-500/10' : 'text-theme-secondary hover:text-theme-primary hover:bg-white/10'}`}
            ...
            {appState !== AppState.UPLOAD && (
               <button onClick={handleReset} className="text-xs font-medium text-theme-secondary hover:text-theme-primary transition-colors px-2">
                  New
               </button>
            )}
          </div>
      ...
      <main className={`flex-grow w-full max-w-5xl mx-auto px-4 pt-32 pb-12 flex flex-col items-center justify-center min-h-[80vh] ${showWelcome ? 'opacity-0 pointer-events-none' : 'opacity-100'} transition-opacity duration-300`}>
        {/* Step 1: Upload */}
        {appState === AppState.UPLOAD && (
          <div className="w-full max-w-2xl text-center space-y-10 animate-fade-in">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-theme-primary leading-[1.1]">
                Your Perfect <br/>
            ...
            >
               <div className="relative card-surface rounded-[2rem] p-12 md:p-16 transition-all duration-300 group-hover:border-blue-600">
        ...
        {appState === AppState.STYLE_SELECT && originalImage && (
          <div className="w-full grid lg:grid-cols-12 gap-8 lg:gap-16 items-start animate-fade-in">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-32 flex flex-col gap-6">
               <div className="relative group rounded-3xl overflow-hidden shadow-2xl shadow-black/50 w-full max-w-sm border-[8px] border-theme mx-auto rotate-1 hover:rotate-0 transition-transform duration-500" style={{ backgroundColor: 'var(--surface-bg)' }}>
               ...
               {/* Controls Panel */}
               <div className="border-theme rounded-2xl p-4 space-y-6 max-w-sm mx-auto w-full" style={{ backgroundColor: 'var(--surface-bg)' }}>
            ...
            <div className="lg:col-span-7 space-y-10">
              <div className="space-y-4">
                <h2 className="text-4xl font-bold text-theme-primary">Select Your Vibe</h2>
                <p className="text-theme-secondary text-lg">Choose a style that fits your personal brand.</p>
              </div>
              ...
              <div className="pt-8 border-t border-theme flex flex-col items-center gap-4">
                <Button 
        ...
        {appState === AppState.RESULT && generatedImage && (
          <div className="w-full max-w-5xl animate-fade-in space-y-12">
            ...
            <div className="text-center space-y-4">
                <h2 className="text-4xl md:text-5xl font-bold text-theme-primary">Your New Look</h2>
            ...
            <div className="grid md:grid-cols-12 gap-8 lg:gap-16 items-start">
               ...
               <div className="md:col-span-7 lg:col-span-8">
                   <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl shadow-black/50 ring-1 border-theme group md:h-[600px] flex items-center justify-center" style={{ backgroundColor: 'var(--surface-bg)' }}>
                      ...
                      <div className="absolute bottom-6 right-6 flex gap-4 z-30 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                         <button onClick={() => window.open(generatedImage, '_blank')} className="pointer-events-auto p-4 bg-white/10 hover:bg-white/20 rounded-full text-theme-primary backdrop-blur-md transition-all hover:scale-110 shadow-lg">
